...
export default function OperadorDashboardGeneral() {
  ...
  const cargarDashboard = async () => {
    try {
      ...
      switch (filtroTiempo) {
        ...
        case 'semana':
          ...
          dashboardResponse = await axios.get(
            `/proxy/api/dashboard/metricas-periodo?fechaInicio=${inicioSemana.toISOString().split('T')[0]}&fechaFin=${finSemana.toISOString().split('T')[0]}`, 
            config
          );
          break;
        ...
        case 'mes':
          ...
          dashboardResponse = await axios.get(
            `/proxy/api/dashboard/metricas-periodo?fechaInicio=${inicioMes.toISOString().split('T')[0]}&fechaFin=${finMes.toISOString().split('T')[0]}`, 
            config
          );
          break;
      ...
      const dashboardData = {
        ...
        metricasRapidas: dashboardResponse.data.data || {},
...
const aplicarFiltroPersonalizado = () => {
  ...
  const datosGrafico = [
    {
      name: 'Entregados',
      value: dashboardGeneral.entregados || 0,
      color: '#28a745'
    },
    {
      name: 'Activos',
      value: dashboardGeneral.activos || 0,
      color: '#ffc107'
    },
    {
      name: 'Cancelados',
            ...
            <div className="card-body">
              <div className="d-flex justify-content-between align-items-center">
                <div>
                  ...
                  <h3 className="fw-bold text-primary mb-0">{dashboardGeneral?.totalPedidos || 0}</h3>
                </div>
            ...
            <div className="card-body">
              <div className="d-flex justify-content-between align-items-center">
                <div>
                  ...
                  <h3 className="fw-bold text-success mb-0">{dashboardGeneral?.entregados || 0}</h3>
                  <small className="text-muted">
                    {dashboardGeneral?.totalPedidos ? 
                      `${((dashboardGeneral.entregados / dashboardGeneral.totalPedidos) * 100).toFixed(1)}%` : 
                      '0%'
                    }
                  </small>
                </div>
            ...
            <div className="card-body">
              <div className="d-flex justify-content-between align-items-center">
                <div>
                  ...
                  <h3 className="fw-bold text-warning mb-0">{dashboardGeneral?.activos || 0}</h3>
            ...
            <div className="card-body">
              <div className="d-flex justify-content-between align-items-center">
                <div>
                  ...
                  <small className="text-muted">
                    {dashboardGeneral?.totalPedidos ? 
                      `${((dashboardGeneral.cancelados / dashboardGeneral.totalPedidos) * 100).toFixed(1)}%` : 
                      '0%'
                    }
                  </small>
                </div>
              ...
              <div className="d-flex justify-content-between align-items-center">
                <div>
                  ...
                  <h4 className="fw-bold text-success mb-0">
                    {formatearMoneda(dashboardGeneral?.ingresos || 0)}
                  </h4>
                </div>
              ...
              <div className="row text-center mb-4">
                ...
                <div className="col-6 mb-3">
                  <h3 className="fw-bold text-success mb-0">
                    {dashboardGeneral?.tasaExito?.toFixed(1) || 0}%
                  </h3>
                  <small className="text-muted">
