...
const ComponenteMapaConRuta = ({ coordenadas, cliente}) => {
  ...
  // Obtener las direcciones predeterminadas del cliente
            ...
            >
              <Popup>
                <div>
                  ...
                  {direccionRecogida?.direccion?.direccionCompleta || 'Dirección de recogida'}
                  {direccionRecogida?.direccion?.ciudad && (
                    <><br /><small className="text-muted">{direccionRecogida.direccion.ciudad}</small></>
                  )}
                </div>
              </Popup>
            </Marker>
            ...
            >
              <Popup>
                <div>
                  ...
                  {direccionEntrega?.direccion?.direccionCompleta || 'Dirección de entrega'}
                  {direccionEntrega?.direccion?.ciudad && (
                    <><br /><small className="text-muted">{direccionEntrega.direccion.ciudad}</small></>
                  )}
                </div>
              </Popup>
            </Marker>
...
const ModalMapaCliente = ({ 
  ...
  // Obtener las direcciones predeterminadas del cliente
  const direccionRecogida = clienteParaMapa?.direcciones?.find(cd => cd.esPredeterminadaRecogida);
  const direccionEntrega = clienteParaMapa?.direcciones?.find(cd => cd.esPredeterminadaEntrega);
          ...
          <div>
            <div className="d-flex justify-content-between align-items-center mb-3">
              <h5>
                ...
                Ubicaciones de {clienteParaMapa?.nombre || 'Cliente'}
              </h5>
              <button 
              ...
              <div className="row">
                <div className="col-md-6">
                  <p>
                    ...
                    <br />
                    <small>
                      {direccionRecogida?.direccion?.direccionCompleta || 'No configurada'}
                      {direccionRecogida?.direccion?.ciudad && (
                        <span className="text-muted"> - {direccionRecogida.direccion.ciudad}</span>
                      )}
                    </small>
                  </p>
                </div>
                <div className="col-md-6">
                  <p>
                    ...
                    <br />
                    <small>
                      {direccionEntrega?.direccion?.direccionCompleta || 'No configurada'}
                      {direccionEntrega?.direccion?.ciudad && (
                        <span className="text-muted"> - {direccionEntrega.direccion.ciudad}</span>
                      )}
                    </small>
                  </p>
                </div>
